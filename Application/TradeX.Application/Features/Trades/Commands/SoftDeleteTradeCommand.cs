...
public sealed class SoftDeleteTradeCommand(Guid id)
    : ContextualRequest,
      ...
      IAuthenticatedRequest
{
    ...
    public sealed class SoftDeleteTradeCommandValidator
        : AbstractValidator<SoftDeleteTradeCommand>
    {
        public SoftDeleteTradeCommandValidator()
        {
            RuleFor(x => x.Id)
                .NotEmpty();
        }
...
public sealed class SoftDeleteTradeCommandHandler(ITradeXRepository repository)
    : IRequestHandler<SoftDeleteTradeCommand, StandardResponse<SoftDeleteEntityResponseModel>>
{
    public async Task<StandardResponse<SoftDeleteEntityResponseModel>> Handle(
        SoftDeleteTradeCommand request,
